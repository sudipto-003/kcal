...
//+kubebuilder:rbac:groups=calc.trod.k8s.io,resources=sums,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=calc.trod.k8s.io,resources=sums/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=calc.trod.k8s.io,resources=sums/finalizers,verbs=update
